...
export function App() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[1320px] flex-col px-4 py-6 sm:px-6 lg:px-10 lg:py-10">
      <section className="panel-surface fade-up rounded-[32px] px-6 py-8 sm:px-8 lg:px-10 lg:py-10">
        <div className="flex flex-col gap-8">
          <header className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_240px] lg:items-end">
            <div>
              <p className="text-sm uppercase tracking-[0.2em] text-[var(--color-accent-strong)]">
                Personal Interview Demo
              </p>
              <h1 className="mt-4 max-w-4xl font-display text-4xl font-semibold tracking-[-0.04em] text-[var(--color-text-primary)] sm:text-5xl lg:text-6xl">
            ...
            <div className="rounded-3xl border border-[var(--color-border)] bg-[rgba(10,18,30,0.86)] p-5 shadow-[var(--shadow-row)]">
              <p className="text-xs uppercase tracking-[0.18em] text-[var(--color-text-muted)]">
                Dataset snapshot
              </p>
              <p className="mt-3 font-display text-3xl font-semibold text-[var(--color-text-primary)]">
                {topics.length}
              </p>
            ...
            <div className="flex flex-col gap-2 border-b border-[var(--color-border)] pb-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <h2
                  ...
                  tabIndex={-1}
                  className="font-display text-2xl font-semibold text-[var(--color-text-primary)] outline-none"
                >
                  Topic results
                </h2>
                <p className="mt-2 text-sm leading-6 text-[var(--color-text-secondary)]">
